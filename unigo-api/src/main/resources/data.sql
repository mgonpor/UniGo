...
INSERT INTO usuario (nombre, username, email, password, rol) VALUES ('Francisco Castro', 'francisco.castro', 'francisco.castro@email.com', '$2a$10$hash26', 'USER');
INSERT INTO usuario (nombre, username, email, password, rol) VALUES ('Pilar Herrera', 'pilar.herrera', 'pilar.herrera@email.com', '$2a$10$hash27', 'USER');
INSERT INTO usuario (nombre, username, email, password, rol) VALUES ('José Álvarez', 'jose.alvarez', 'jose.alvarez@email.com', '$2a$10$hash28', 'USER');
INSERT INTO usuario (nombre, username, email, password, rol) VALUES ('Montserrat Fuentes', 'montserrat.fuentes', 'montserrat.fuentes@email.com', '$2a$10$hash29', 'USER');
INSERT INTO usuario (nombre, username, email, password, rol) VALUES ('Rubén Campos', 'ruben.campos', 'ruben.campos@email.com', '$2a$10$hash30', 'USER');
INSERT INTO usuario (nombre, username, email, password, rol) VALUES ('Silvia Ramos', 'silvia.ramos', 'silvia.ramos@email.com', '$2a$10$hash31', 'USER');
INSERT INTO usuario (nombre, username, email, password, rol) VALUES ('Enrique Cano', 'enrique.cano', 'enrique.cano@email.com', '$2a$10$hash32', 'USER');
INSERT INTO usuario (nombre, username, email, password, rol) VALUES ('Dolores Prieto', 'dolores.prieto', 'dolores.prieto@email.com', '$2a$10$hash33', 'USER');
INSERT INTO usuario (nombre, username, email, password, rol) VALUES ('Julio Pascual', 'julio.pascual', 'julio.pascual@email.com', '$2a$10$hash34', 'USER');
INSERT INTO usuario (nombre, username, email, password, rol) VALUES ('Amparo Santos', 'amparo.santos', 'amparo.santos@email.com', '$2a$10$hash35', 'USER');
INSERT INTO usuario (nombre, username, email, password, rol) VALUES ('Ramón Lorenzo', 'ramon.lorenzo', 'ramon.lorenzo@email.com', '$2a$10$hash36', 'USER');
INSERT INTO usuario (nombre, username, email, password, rol) VALUES ('Mercedes Benítez', 'mercedes.benitez', 'mercedes.benitez@email.com', '$2a$10$hash37', 'USER');
INSERT INTO usuario (nombre, username, email, password, rol) VALUES ('Salvador Hidalgo', 'salvador.hidalgo', 'salvador.hidalgo@email.com', '$2a$10$hash38', 'USER');
INSERT INTO usuario (nombre, username, email, password, rol) VALUES ('Consuelo León', 'consuelo.leon', 'consuelo.leon@email.com', '$2a$10$hash39', 'USER');
INSERT INTO usuario (nombre, username, email, password, rol) VALUES ('Tomás Marín', 'tomas.marin', 'tomas.marin@email.com', '$2a$10$hash40', 'USER');
INSERT INTO usuario (nombre, username, email, password, rol) VALUES ('Josefa Gallego', 'josefa.gallego', 'josefa.gallego@email.com', '$2a$10$hash41', 'USER');
INSERT INTO usuario (nombre, username, email, password, rol) VALUES ('Joaquín Vidal', 'joaquin.vidal', 'joaquin.vidal@email.com', '$2a$10$hash42', 'USER');
INSERT INTO usuario (nombre, username, email, password, rol) VALUES ('Encarnación Méndez', 'encarnacion.mendez', 'encarnacion.mendez@email.com', '$2a$10$hash43', 'USER');
INSERT INTO usuario (nombre, username, email, password, rol) VALUES ('Alfredo Cabrera', 'alfredo.cabrera', 'alfredo.cabrera@email.com', '$2a$10$hash44', 'USER');
INSERT INTO usuario (nombre, username, email, password, rol) VALUES ('Victoria Sanz', 'victoria.sanz', 'victoria.sanz@email.com', '$2a$10$hash45', 'USER');
INSERT INTO usuario (nombre, username, email, password, rol) VALUES ('Luis Domínguez', 'luis.dominguez', 'luis.dominguez@email.com', '$2a$10$hash46', 'USER');
INSERT INTO usuario (nombre, username, email, password, rol) VALUES ('Asunción Reyes', 'asuncion.reyes', 'asuncion.reyes@email.com', '$2a$10$hash47', 'USER');
INSERT INTO usuario (nombre, username, email, password, rol) VALUES ('Emilio Cruz', 'emilio.cruz', 'emilio.cruz@email.com', '$2a$10$hash48', 'USER');
INSERT INTO usuario (nombre, username, email, password, rol) VALUES ('Rosario Peña', 'rosario.pena', 'rosario.pena@email.com', '$2a$10$hash49', 'USER');
INSERT INTO usuario (nombre, username, email, password, rol) VALUES ('Andrés Rojas', 'andres.rojas', 'andres.rojas@email.com', '$2a$10$hash50', 'USER');
